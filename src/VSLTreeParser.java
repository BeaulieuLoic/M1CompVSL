...
public class VSLTreeParser extends TreeParser {
		...
		try {
			...
			switch (alt1) {
				case 1 :
					...
					break;
				case 2 :
					// ./src/VSLTreeParser.g:21:4: ^( MINUS e1= expression[symTab] e2= expression[symTab] )
					{
					match(input,MINUS,FOLLOW_MINUS_in_expression107); 
					match(input, Token.DOWN, null); 
					...
					break;
				case 3 :
					// ./src/VSLTreeParser.g:28:4: ^( MUL e1= expression[symTab] e2= expression[symTab] )
					{
					match(input,MUL,FOLLOW_MUL_in_expression131); 
					match(input, Token.DOWN, null); 
				...
				case 4 :
					...
					{
					match(input,DIV,FOLLOW_DIV_in_expression156); 
					match(input, Token.DOWN, null); 
				...
				case 5 :
					...
					{
					pushFollow(FOLLOW_primary_exp_in_expression182);
	...
	public static final BitSet FOLLOW_MINUS_in_expression107 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_expression_in_expression111 = new BitSet(new long[]{0x0000000002C14200L});
	public static final BitSet FOLLOW_expression_in_expression116 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_MUL_in_expression131 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_expression_in_expression135 = new BitSet(new long[]{0x0000000002C14200L});
	public static final BitSet FOLLOW_expression_in_expression140 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_DIV_in_expression156 = new BitSet(new long[]{0x0000000000000004L});
